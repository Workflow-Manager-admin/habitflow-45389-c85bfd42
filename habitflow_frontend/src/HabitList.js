  ...
  return (
    <>
      <div className="habit-list-grid">
        {habits.map(habit => (
          <div
            className={`habit-card fade-in${habit.doneToday ? " habit-card-done" : ""}`}
            key={habit.id}
          >
            <div className="habit-card-row habit-card-header" style={{fontFamily: "'Poppins','Inter',Arial,sans-serif"}}>
              ...
              <div className="habit-card-actions">
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 18 18">
                    <rect x="5" y="6.5" width="8" height="8" rx="2" fill="#f4c2c2"/>
                    <rect x="7" y="3.5" width="4" height="2" rx="1" fill="#a3d5ff"/>
                  </svg>
                </span>
              </div>
            </div>
              ...
              <span className="habit-streak-badge">
                ...
                <svg width="15" height="15" viewBox="0 0 15 15">
                  <path
                    ...
                    strokeWidth="0.7"
                  />
                  <circle cx="7.5" cy="11" r="2" fill="#e4ecf7" />
                </svg>{" "}
            ...
            <div className="habit-card-row done-checkbox-row">
              <label className="habit-done-label">
                <input
                  ...
                  style={{
                    transition: 'box-shadow 0.21s, border-color 0.13s, background 0.13s'
                  }}
                />
                <span>
                  Done for Today
